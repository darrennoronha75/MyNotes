...
>
> It maps outcomes from an unpredictable eventÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Âthe sample space ($\Omega$)ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Âto a measurable real number ($\mathbb{R}$).
...
# 2. Simulate the unpredictable events (ÃƒÅ½Ã‚Â©)
